package com.hossam.elabda3.dao;
...
public class CartOffline {
    ...
    public CartOffline(String pid, long quantity, String price, String name, String imageUrl, String priceUnit, String priceUnitName, String priceUnitId) {
        this.pid = pid;
